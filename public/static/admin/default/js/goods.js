...
$(function()
{
    ...
    {
        var index = $(this).data('cuika.view.cuika.index.index');
    ...
    $(document).on('click', '.content-app-items-add-sub', function()
    {
        ...
        var i = (($(this).attr('cuika.view.cuika.index.index') || null) == null) ? parseInt($content_tag.find('li').length) : parseInt($(this).attr('cuika.view.cuika.index.index'));
        ...
        $content_tag.attr('cuika.view.cuika.index.index', index);
        $(this).attr('cuika.view.cuika.index.index', i+1);
    });
