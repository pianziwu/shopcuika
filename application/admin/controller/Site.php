...
class Site extends Common
{
	...
	public function Index()
	{
		...
		// 官方微信二维码 home_site_weixin_qrcode_images
		$this->assign('home_site_weixin_qrcode_images', lang('home_site_weixin_qrcode_images'));

		// 官方微信二维码 home_site_weibo_qrcode_images
		$this->assign('home_site_weibo_qrcode_images', lang('home_site_weibo_qrcode_images'));
