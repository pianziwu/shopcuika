...
use app\service\GoodsAttributeJoin;
...
class Goods extends Common
{
	...
	public function SaveInfo()
	{
		...
		if(!empty($params['id']))
		{
            ...
            // 属性
            $this->assign('goods_attribute', GoodsAttributeJoin::getFind(['goods_id' => $params['id']]));
            //  内容详情
            $this->assign('goods_detail', GoodsDetail::getListAll(['goods_id' => $params['id']]));
		}
