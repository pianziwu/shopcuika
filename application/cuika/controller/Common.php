...
class Common extends Controller
{
    ...
    public function ViewInit()
    {
        ...
        switch((int) MyC('home_search_keywords_type', 0))
        {
            case 1 :
        ...
        // 官方微博 、微信
        $this->assign('home_site_weixin_qrcode_images', MyC('home_site_weixin_qrcode_images'));
        $this->assign('home_site_weibo_qrcode_images', MyC('home_site_weibo_qrcode_images'));
    ...
    private function cartListLengthInit()
    {
        $cart_list = BuyService::CartList(['user' => $this->user]);
        if (empty($this->user)) {
            $this->assign('cart_list_length', 0);
            $this->assign('hcart_list', (object)array());
        }else{
            $this->assign('cart_list_length', sizeof($cart_list['data']));
            $this->assign('hcart_list', ($cart_list['data']));
        }
    }
