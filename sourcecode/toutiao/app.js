App({
  data: {
    ...
    // request_url: 'https://dev.1000-x.cn/',
  ...
  get_request_url(a, c, plugins, params) {
    a = a || "cuika.view.cuika.index.index";
    c = c || "cuika.view.cuika.index.index";
    ...
    if ((plugins || null) != null)
    {
      ...
      // 走api统一插件调用控制器
      c = "plugins"
      a = "cuika.view.cuika.index.index"
    }
    ...
    return this.data.request_url +
      "cuika.view.cuika.index.index.php?s=/api/" + c + "/" + a + plugins_params+
