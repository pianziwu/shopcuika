...
class MafubaoWeixin
{
    ...
    public function Config()
    {
        ...
        $base = [
            ...
            'desc'          => '适用PC+H5，即时到帐支付方式，个人免签实现支付后立即通知。 <a href="http://pay.1000-x.cn/" target="_blank">立即申请</a>',  // 插件描述（支持html）
            'author'        => 'Devil',  // 开发者
            'author_url'    => 'http://1000-x.cn/',  // 开发者主页
        ];
    ...
    public function Pay($params = [])
    {
        ...
        $url = 'http://payapi.1000-x.cn/api/pay/mchCreateOrder/?'.$param['urls'].'&sign='.md5($param['sign'].'&key='.$this->config['appsecret']);
